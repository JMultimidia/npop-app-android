var app = {
    ...
    osInit: function () {
        ...
        window.plugins.OneSignal.getIds(id => {
            ...
            var Url = "https://negociopopular.com.br/cliente";
            var data = {
            ...
            $.post(Url, data)
                .done(function (data, status) {
                    ...
                    app.goFrame(
                        "https://negociopopular.com.br/appwebview?info=" + deviceUID,
                        "" + app_name + ""
                    );
                })
    ...
    goFrame: function (source, name) {
        ...
        menuHide();
        $.ajax({
            url: source + "?info=" + app.osInit.deviceUID,
            dataType: "html",
            type: "GET",
            async: true,
